...
import 'package:network_service/network/service/network_cache_service.dart';
...
class NetworkService {
  ...
  static late NetworkCacheService _networkCacheService;

  static ApiRequest get apiRequest => _apiRequest;

  static ApiManager get apiManager => _apiManager;

  static NetworkCacheService get networkCacheService => _networkCacheService;
  ...
  static void configureNetworkService({
    ...
    _networkCacheService = NetworkCacheServiceImpl();
    await _networkCacheService.initCacheService();
